...
digits = "zero one two three four five six seven ater nine".split()
f_digits = "one two three four five six seven ater nine ten eleven twelve thirteen fourteen fifteen sixteen seventeen eighteen nineteen twenty".split()
